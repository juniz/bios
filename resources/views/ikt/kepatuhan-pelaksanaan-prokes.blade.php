...
@section('title', 'Kepatuhan Pelaksanaan Protokol Kesehatan')

@section('content_header')
    <h1>Kepatuhan Pelaksanaan Protokol Kesehatan</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Pelaksanaan Protokol Kesehatan" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Pelaksanaan Protokol Kesehatan" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableProkes" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_pelaksanaan_prokes/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
