...
@section('title', 'Kepatuhan Penggunaan Alat Pelindung Diri (APD)')

@section('content_header')
    <h1>Kepatuhan Penggunaan Alat Pelindung Diri (APD)</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Penggunaan Alat Pelindung Diri (APD)" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Penggunaan Alat Pelindung Diri (APD)" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableAPD" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_penggunaan_apd/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
