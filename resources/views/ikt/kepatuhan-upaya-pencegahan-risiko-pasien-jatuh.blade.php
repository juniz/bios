...
@section('title', 'Kepatuhan Upaya Pencegahan Resiko Pasien Jatuh')

@section('content_header')
    <h1>Kepatuhan Upaya Pencegahan Resiko Pasien Jatuh</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Upaya Pencegahan Resiko Pasien Jatuh" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Upaya Pencegahan Resiko Pasien Jatuh" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableResiko" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_upaya_pencegahan_risiko_pasien_jatuh/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
