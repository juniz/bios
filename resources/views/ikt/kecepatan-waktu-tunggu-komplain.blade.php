...
@section('title', 'Kecepatan Waktu Tanggap Komplain')

@section('content_header')
    <h1>Kecepatan Waktu Tanggap Komplain</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kecepatan Waktu Tanggap Komplain" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kecepatan Waktu Tanggap Komplain" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kecepatan_waktu_tunggu_komplain/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
