...
@section('title', 'Kepatuhan Penggunaan Formularium Nasional')

@section('content_header')
    <h1>Kepatuhan Penggunaan Formularium Nasional</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Penggunaan Formularium Nasional" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Penggunaan Formularium Nasional" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableFornas" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_penggunaan_fornas/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
