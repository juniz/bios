...
@section('content_header')
    <h1>Kepuasan Pasien</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepuasan Pasien" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepuasan Pasien" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableKepuasanPasien" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
