...
@section('title', 'Penyelenggaran Rekam Medis Elektronik')

@section('content_header')
    <h1>Penyelenggaran Rekam Medis Elektronik</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Penyelenggaran Rekam Medis Elektronik" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Penyelenggaran Rekam Medis Elektronik" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableERM" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/penyelenggaraan_erm/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
