...
@section('title', 'Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU')

@section('content_header')
    <h1>Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableBLU" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/pertumbuhan_realisasi_pendapatan_pengelolaan_aset_blu/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
