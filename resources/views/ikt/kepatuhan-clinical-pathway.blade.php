...
@section('title', 'Kepatuhan Terhadap Alur Klinis (Clinical Pathway)')

@section('content_header')
    <h1>Kepatuhan Terhadap Alur Klinis (Clinical Pathway)</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Terhadap Alur Klinis (Clinical Pathway)" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Terhadap Alur Klinis (Clinical Pathway)" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableClinicalPathway" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_clinical_pathway/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
