...
@section('content_header')
    <h1>Visite Pasien > 10.00 s.d. 12.00</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Jumlah Visite Pasien > 10.00 s.d. 12.00" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Jumlah Visite Pasien > 10.00 s.d. 12.00" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableVisite2" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
