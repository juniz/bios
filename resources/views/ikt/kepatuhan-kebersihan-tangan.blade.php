...
@section('title', 'Kepatuhan Kebersihan Tangan')

@section('content_header')
    <h1>Kepatuhan Kebersihan Tangan</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Kebersihan Tangan" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Kebersihan Tangan" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableKebersihanTangan" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_kebersihan_tangan/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
