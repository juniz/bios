...
@section('content_header')
    <h1>Kegiatan Visite Pasien Pertama</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kegiatan Visite Pasien Pertama" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kegiatan Visite Pasien Pertama" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableVisitePertama" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
