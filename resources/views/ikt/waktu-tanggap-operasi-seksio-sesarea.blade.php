...
@section('title', 'Waktu Tanggap Operasi Seksio Sesarea Emergensi')

@section('content_header')
    <h1>Waktu Tanggap Operasi Seksio Sesarea Emergensi</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Waktu Tanggap Operasi Seksio Sesarea Emergensi" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Waktu Tanggap Operasi Seksio Sesarea Emergensi" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableKomplain" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/waktu_tanggap_operasi_seksio_sesarea/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
