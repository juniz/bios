...
@section('title', 'Penundaan Operasi Elektif')

@section('content_header')
    <h1>Penundaan Operasi Elektif</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Penundaan Operasi Elektif" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Penundaan Operasi Elektif" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableElektif" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/penundaan_operasi_elektif/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
