...
@section('title', 'Persentase Pembelian Alat Kesehatan Produksi Dalam Negeri')

@section('content_header')
    <h1>Persentase Pembelian Alat Kesehatan Produksi Dalam Negeri</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Persentase Pembelian Alat Kesehatan Produksi Dalam Negeri" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Persentase Pembelian Alat Kesehatan Produksi Dalam Negeri" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableAlkes" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/pembelian_alkes_dalam_negeri/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
