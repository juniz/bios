...
@section('content_header')
    <h1>Waktu Tunggu Rawat Jalan</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Waktu Tunggu Rawat Jalan" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Waktu Tunggu Rawat Jalan" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableTungguRawatJalan" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/waktu_tunggu_ralan/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
