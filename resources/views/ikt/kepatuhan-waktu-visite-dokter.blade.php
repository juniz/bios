...
@section('title', 'Kepatuhan Waktu Visite Dokter')

@section('content_header')
    <h1>Kepatuhan Waktu Visite Dokter</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Waktu Visite Dokter" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Waktu Visite Dokter" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableVisite" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_waktu_visite_dokter/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
