...
@section('title', 'Kepatuhan Identifikasi Pasien')

@section('content_header')
    <h1>Kepatuhan Identifikasi Pasien</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Kepatuhan Identifikasi Pasien" theme="dark" theme-mode="outline">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Kepatuhan Identifikasi Pasien" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableIdentifikasi" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
...
@section('js')
    ...
    <script>
        function kirimDataPerawat() {
            ...
            $.ajax({
                type:'POST',
                url:'/ikt/kepatuhan_identifikasi_pasien/kirim',
                data:data,
                dataType:'json',
                beforeSend:function() {
                    Swal.fire({
