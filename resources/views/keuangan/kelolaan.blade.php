    ...
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Saldo Rekening - Dana Kelolaan" theme="dark" theme-mode="outline">
                ...
                <x-adminlte-input id="saldo_akhir" name="saldo_akhir" label="Saldo Akhir" type="number" fgroup-class="col-md-12" disable-feedback/>
                @php
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Saldo Rekening - Dana Kelolaan" theme="dark" theme-mode="outline">
                ...
                @endphp
                <x-adminlte-datatable id="tableKelolaan" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
