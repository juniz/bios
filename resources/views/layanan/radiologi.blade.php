...
@section('content_header')
    <h1>Jumlah Layanan Radiologi</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Jumlah Layanan Radiologi" theme="dark" theme-mode="outline">
                <div class="row">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Jumlah Layanan Radiologi" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableRadiologi" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
