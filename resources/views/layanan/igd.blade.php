...
@section('content_header')
    <h1>Jumlah Pasien Rawat Darurat</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Jumlah Pasien Rawat Darurat" theme="dark" theme-mode="outline">
                <div class="row">
                    <x-adminlte-input id="jumlah" name="jumlah" label="Jumlah" value="{{$jumlah}}" type="number" fgroup-class="col-md-6" disable-feedback/>
                    <div class="col-md-6">
                        @php
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Jumlah Pasien Rawat Darurat" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
                ...
                @endphp
                <x-adminlte-datatable id="tableJumlahIGD" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
