...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Jumlah BTO (Bed Turn Over)" theme="dark" theme-mode="outline">
                <div class="row">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Jumlah BTO (Bed Turn Over)" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
