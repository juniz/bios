...
<div class="row">
    <div class="col-md-12">
        <x-adminlte-card theme="dark" theme-mode="outline">
            <div class="row">
                <x-adminlte-input id="jumlah" name="jumlah" label="Jumlah BOR" type="number" value="0"
    ...
    <div class="col-md-12">
        <x-adminlte-card theme="dark" theme-mode="outline">
            ...
            @endphp
            <x-adminlte-datatable id="tableJumlahBOR" :heads="$head" head-theme="dark" :config="$config" striped
                ...
                <tr @if($data->response == 'MSG20003') class="bg-success" @endif>
                    ...
                    <td>
                        <x-adminlte-button label="Kirim Ulang"
                            onclick="kirimUlang('{{$data->tgl_transaksi}}','{{$data->bor}}')" class="btn-sm"
