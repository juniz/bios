...
@section('content_header')
    <h1>Jumlah Layanan Farmasi</h1>
@stop

@section('content')
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-card title="Input Jumlah Layanan Farmasi" theme="dark" theme-mode="outline">
                <div class="row">
        ...
        <div class="col-md-6">
            <x-adminlte-card title="Data Jumlah Layanan Farmasi" theme="dark" theme-mode="outline">
                @php
                    $config = [
                        'order' => [[0, 'desc']],
                        "responsive" => true,
