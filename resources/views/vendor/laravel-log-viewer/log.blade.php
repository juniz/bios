    ...
    <div class="col-10 table-container">
      ...
      @else
          @php
            ...
            $head = ['Level', 'Context', 'Date', 'Content'];
        @endphp
        <x-adminlte-datatable id="tableCronLayanan" :heads="$head" head-theme="dark" :config="$config" striped hoverable bordered compressed>
