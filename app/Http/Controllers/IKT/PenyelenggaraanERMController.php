...
class PenyelenggaraanERMController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'kesehatan/ikt/penyelenggaraan_erm';
        $this->data = $this->read();
        ...
        $this->keterangan = [
            ...
            'Data dikirimkan per periode triwulanan.'
        ];
    }

    public function index()
    {
        return view('ikt.penyelenggaraan-erm',[
            'data' => $this->data, 
            'head' => $this->headTable, 
