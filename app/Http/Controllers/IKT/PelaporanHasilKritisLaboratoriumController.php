...
class PelaporanHasilKritisLaboratoriumController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'kesehatan/ikt/pelaporan_hasil_kritis_laboratorium';
        $this->data = $this->read();
    ...
    {
        return view('ikt.pelaporan-hasil-kritis-laboratorium',[
            'data' => $this->data, 
            'head' => $this->headTable, 
