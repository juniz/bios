...
class KecepatanWaktuTungguKomplainController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'kesehatan/ikt/kecepatan_waktu_tunggu_komplain';
        $this->data = $this->read();
    ...
    {
        return view('ikt.kecepatan-waktu-tunggu-komplain',[
            'data' => $this->data, 
            'head' => $this->headTable, 
