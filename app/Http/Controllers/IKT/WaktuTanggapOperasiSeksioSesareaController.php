...
class WaktuTanggapOperasiSeksioSesareaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'kesehatan/ikt/waktu_tanggap_operasi_seksio_sesarea';
        $this->data = $this->read();
    ...
    {
        return view('ikt.waktu-tanggap-operasi-seksio-sesarea',[
            'data' => $this->data, 
            'head' => $this->headTable, 
