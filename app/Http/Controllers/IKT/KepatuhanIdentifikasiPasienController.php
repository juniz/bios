...
class KepatuhanIdentifikasiPasienController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'kesehatan/ikt/kepatuhan_identifikasi_pasien';
        $this->data = $this->read();
        ...
        $this->keterangan = [
            ...
            'Data dikirimkan per periode bulanan/triwulanan/tahunan.'
        ];
    }

    public function index()
    {
        return view('ikt.kepatuhan-identifikasi-pasien',[
            'data' => $this->data, 
            'head' => $this->headTable, 
