...
class KepatuhanWaktuVisiteDokterController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'kesehatan/ikt/kepatuhan_waktu_visite_dokter';
        $this->data = $this->read();
    ...
    {
        return view('ikt.kepatuhan-waktu-visite-dokter',[
            'data' => $this->data, 
            'head' => $this->headTable, 
