...
class KepatuhanPenggunaanFornasController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->url = 'kesehatan/ikt/kepatuhan_penggunaan_fornas';
        $this->data = $this->read();
    ...
    {
        return view('ikt.kepatuhan-penggunaan-fornas',[
            'data' => $this->data, 
            'head' => $this->headTable, 
