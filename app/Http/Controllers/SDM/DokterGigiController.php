...
class DokterGigiController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->bidang = 'DOKTER GIGI';
        $this->url = 'kesehatan/sdm/dokter_gigi';
        $this->data = $this->read();
    ...
    {
        $input = $request->all();
        $response = $this->postData($this->url, $this->header, $input, 'bios_log_dokter_gigi');
