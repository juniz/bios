...
class DokterUmumController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->bidang = 'DOKTER UMUM';
        $this->url = 'kesehatan/sdm/dokter_umum';
        $this->data = $this->read();
    ...
    {
        $input = $request->all();
        $response = $this->postData($this->url, $this->header, $input, 'bios_log_dokter_umum');
