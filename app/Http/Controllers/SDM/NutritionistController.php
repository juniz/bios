...
class NutritionistController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->bidang = 'NUTRITIONIST';
        $this->url = 'kesehatan/sdm/nutritionist';
        $this->data = $this->read();
    ...
    {
        $input = $request->all();
        $response = $this->postData($this->url, $this->header, $input, 'bios_log_nutritionist');
